...
#   kmeans = sklearn.cluster.MiniBatchKMeans(n_clusters=num_clusters, n_init=10, batch_size=1000)
...
def compute_prd_from_embedding(eval_data, ref_data, num_clusters=50,
  ...
  precisions = []
  recalls = []
  steps_range = trange((num_runs), desc='Calculating Precision/Recall:', leave=True, ascii ="         =")
